...
import com.nicholasung.javaBeltExam.services.UserProjectService;
...
public class ProjectTaskController {
	   ...
	   @Autowired
	   private UserProjectService userProjServ;
	   ...
	   public String joinTeam(@PathVariable("userId") Long userId, 
		   ...
		   userProjServ.addUserToProject(projectId, userId);
	   ...
	   public String leaveTeam(@PathVariable("userId") Long userId, 
			   @PathVariable("projectId") Long projectId) {
		   userProjServ.removeUserFromProject(projectId, userId);
		   return "redirect:/projects";
	   }
	   ...
	   public String addProject(HttpSession session,
		   ...
		   userProjServ.addUserToProject(filledProject.getId(), user.getId());
		   return "redirect:/projects";
	   }
	   ...
	   public String editProject(HttpSession session, @PathVariable("id") Long id,
		   ...
		   userProjServ.addUserToProject(editedProject.getId(), user.getId());
		   return "redirect:/projects";
	   }
