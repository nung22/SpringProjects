...
import com.nicholasung.projectmanager.repositories.ProjectRepository;
import com.nicholasung.projectmanager.repositories.UserRepository;
...
//    		return null;
//    	}
//        List<Project> projectsNotJoined = this.allProjects();
//    	for(Project userProject: this.allProjectsOnTeam(user)) {
//    		if(projectsNotJoined.contains(userProject)) {
//    			projectsNotJoined.remove(userProject);
//    		}
//    	}
//    	return projectsNotJoined;
    }
